...
<div class="team4 pt-5">
  <div class="container">
    <div class="row justify-content-center mb-4">
      <div class="col-md-7 text-center">
        <h3 class="mb-3">Experienced <span class="text-danger"> & </span> Professional Team</h3>
          ...
          <div class="col-md-12 text-center">
            <div class="pt-2">
              ...
              <ul class="list-inline">
                <li class="list-inline-item"><a href="#" class="text-decoration-none d-block px-1"><i class="fa fa-facebook fa1"></i></a></li>
...
<section class="counter-sec my-5">
<div class="container">
    <div class="row">
