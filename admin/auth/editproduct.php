...
<form method="post" action="updateproduct.php" enctype="multipart/form-data" id="update">
    ...
    <div class="row">
        ...
        ?>
            ...
            <div class="col-md-12 col-lg-12 mt-4">
                ...
                <div class="form-group">
                    <textarea class="form-control editor" name="p_desc" id="p_desc"><?php echo $row['product_desc'] ?></textarea>
                </div>
            <?php
        }
            ?>
